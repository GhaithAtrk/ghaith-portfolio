...
const Learning = () => {
  ...
  return (
    <div className="learning max-w-[1240px] relative mx-auto flex flex-col justify-center h-screen">
      <h2 className="text-4xl my-4 mb-8 font-bold text-center md:text-left">
        What Am I Learning Currently?
      </h2>
      <div className="flex flex-col md:flex-row justify-around items-center">
        <div
          className={`bg-white/85 w-[90%] md:w-[500px] p-6 rounded-md border-black border-2 leading-loose`}
        >
